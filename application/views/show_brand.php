...
<body class="hold-transition skin-blue sidebar-mini">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        <li><a href="<?php echo base_url() . "Add_Brand" ?>">
        <button class="btn btn-warning">Add New Inventory Brands</button></a></li>
 ...
 <div class="col-md-3">
    ...
    <?php } ?></h4>
       ...
       <th style="background-color: #E2E2E2;">Brand Name</th>
       ...
       <th style="text-align: center;background-color: #E2E2E2;">Delete</th>
        ...
        <td style="border: 1px solid #F4F4F4;"><?php echo $brand_name; ?></td>
          ...
          <td style="border: 1px solid #F4F4F4;" align="center"><a href="<?php echo base_url() . "Add_Brand/show_brand_id/" . $brand_id; ?>"><i class="fa fa-pencil" style="color: blue;font-size: 18px;"></i></a>
          </td>
           <td style="border: 1px solid #F4F4F4;" align="center"><a href="<?php echo base_url() . "Add_Brand/delete_brand/" . $brand_id; ?>" onclick="return confirm('Are you sure?')"><i class="fa fa-remove" style="color: red;font-size: 18px;"></i></a>
          </td>
        </tr>
       <?php $row_count++; } ?>
                </tbody>
