...
<head>
  ...
  <title>Update Inventory Category</title>
...
<body class="hold-transition skin-blue sidebar-mini" style="font-family: calibri;">
  ...
  <?php include 'top1.php'; ?>
   <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <?php foreach ($single_category as $p): ?>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
       <div class="col-md-4" style="margin-left: -15px;">
          <div class="small-box bg-blue-gradient">
            <div class="inner">
              <h2>Update Inventory Category</h2>
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="#">Update Inventory Category</a></li>
    ...
    <?php echo form_open_multipart('Add_Category/update_category_id'); ?>
        <div class="row">
          ...
          <div class="box box-primary">
            <div class="box-header with-border" style="background-color: #ECF0F5;">
              ...
              <div class="box-body" style="background-color: #ECF0F5;">
               <input type="hidden" name="id" value="<?php echo $p->category_id; ?>">
            
                 <div class="form-group">
                  <label for="fname"><b>Category Name</b>
            <font color="red"><p style="font-size: 8px;"><b>
             <?php echo form_error('category_name'); ?></b></p></font>
            </label>
                     <input onfocus="var temp_value=this.value; this.value=''; this.value=temp_value" type="text" value="<?php echo $p->category_name; ?>" class="form-control" name="category_name" required autofocus="">
                </div>
     ...
     <a href="<?php echo base_url() . "Add_Category/show_category" ?>">
