...
<body class="hold-transition skin-blue sidebar-mini">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        <li><a href="<?php echo base_url() . "Add_Requisition_slip/insert_requisition_slip/".$single_request->user_id ."/".$request_id ;?>">
        <button class="btn btn-warning">Add New Requisition Slip</button></a></li>
 ...
 <div class="col-md-3">
    ...
    <?php } ?></h4>
        ...
        <thead>
          ...
          <th style="text-align: center;background-color: #E2E2E2;">Allot Item</th>
        ...
        $row_count = 1;
             foreach ($all_item as $row) {
                ...
                foreach ($all_type as $row_type) {
                    ...
                    if($requisition_slip_id == '0'){
                      $requisition_slip_description ="Existing";
                    }

                    elseif($requisition_slip_id != '0'){
        ...
        <form action="<?php echo base_url('Add_Allotment/savedata') ?>" method="POST">
          ...
          <input type="hidden" name="user_id" value="<?php echo $single_request->user_id; ?>"> 
          <input type="hidden" name="request_id" value="<?php echo $request_id; ?>"> 
