...
<body class="hold-transition skin-blue sidebar-mini" style="font-family: calibri;">
  ...
  <div class="form-group col-md-12">
                ...
                <div class="col-md-4">
                    ...
                    <?php foreach ($all_item as $row_item) { ?>
  ...
  <input type="hidden" value="<?php echo $user; ?>" class="form-control" name="user" required>
  <input type="hidden" value="<?php echo $request_id; ?>" class="form-control" name="request_id" required>
