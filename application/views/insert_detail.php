...
<head>
  ...
  <title>Search Item Deatil</title>
...
<body class="hold-transition skin-blue sidebar-mini" style="font-family: calibri;">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
        <div class="col-md-3" style="margin-left: -15px;">
          <div class="small-box bg-blue-gradient">
            <div class="inner">
              <h2>Search Item Detail</h2>
            </div>
          </div>
 </div>
      <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
        <li><a href="#">Search Item Detail</a></li>
    ...
    <?php echo form_open_multipart('Show_Detail/show_detail'); ?>
        <div class="row">
          ...
          <div class="box box-primary">
            <div class="box-header with-border" style="background-color: #ECF0F5;">
              ...
              <div class="box-body" style="background-color: #ECF0F5;">
                 ...
                 <div class="form-group">
                  <label for="fname"><b>Enter Barcode Number</b>
            <font color="red"><p style="font-size: 8px;"><b>
             <?php echo form_error('barcode'); ?></b></p></font>
            </label>
                     <input onfocus="var temp_value=this.value; this.value=''; this.value=temp_value" type="text" value="<?php echo set_value('barcode'); ?>" class="form-control" name="barcode" required autofocus="">
                </div>
            ...
            <input type="hidden" value="<?php echo ($this->session->userdata['logged_in']['user_id']); ?>" class="form-control" name="by_user" required>
             ...
             <button type="submit" style="width: 20%;float: left;" class="btn btn-success">Search</button>
