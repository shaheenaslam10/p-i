 ...
 <div class="col-md-3">
    ...
    <thead>        
      <tr style="color: #215D9B;">
        ...
        <th style="text-align: center;background-color: #E2E2E2;">Accept</th>
        <th style="text-align: center;background-color: #E2E2E2;">Reject</th>
      </tr>
    </thead>
  <tbody>
        <?php
        $row_count = 1;
             foreach ($requestlm as $row) {
        ...
        <td style="border: 1px solid #F4F4F4;" align="center"><a href="<?php echo base_url() . "Add_Request/status_accept/" . $request_id; ?> "onclick="return confirm('Are you sure?')"><i class="fa fa-check" style="color: green;font-size: 18px;"></i></a></td>
        <td style="border: 1px solid #F4F4F4;" align="center"><a href="<?php echo base_url() . "Add_Request/status_reject/" . $request_id; ?>" onclick="return confirm('Are you sure?')"><i class="fa fa-remove" style="color: red;font-size: 18px;"></i></a></td>
