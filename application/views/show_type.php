...
<body class="hold-transition skin-blue sidebar-mini">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        <li><a href="<?php echo base_url() . "Add_Type" ?>">
        <button class="btn btn-warning">Add New Inventory Types</button></a></li>
 ...
 <div class="col-md-3">
    ...
    <?php } ?></h4>
       ...
       <th style="background-color: #E2E2E2;">Type Name</th>
       ...
       <th style="text-align: center;background-color: #E2E2E2;">Delete</th>
        ...
        <td style="border: 1px solid #F4F4F4;"><?php echo $type_name; ?></td>
          ...
          <td style="border: 1px solid #F4F4F4;" align="center"><a href="<?php echo base_url() . "Add_Type/show_type_id/" . $type_id; ?>"><i class="fa fa-pencil" style="color: blue;font-size: 18px;"></i></a>
          </td>
           <td style="border: 1px solid #F4F4F4;" align="center"><a href="<?php echo base_url() . "Add_Type/delete_type/" . $type_id; ?>" onclick="return confirm('Are you sure?')"><i class="fa fa-remove" style="color: red;font-size: 18px;"></i></a>
          </td>
        </tr>
       <?php $row_count++; } ?>
                </tbody>
