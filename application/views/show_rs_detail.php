...
<body class="hold-transition skin-blue sidebar-mini">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        <li><a href="<?php echo base_url() . "Add_Rs_detail" ?>">
 ...
 <div class="col-md-3">
    ...
    <?php } ?></h4>
        ...
        <td style="border: 1px solid #F4F4F4;"><?php echo $maintenance_due_date; ?></td>
          ...
          <td style="border: 1px solid #F4F4F4;" align="center"><a href="<?php echo base_url() . "Add_Rs_detail/show_rs_detail_id/" . $rs_detail_id; ?>"><i class="fa fa-pencil" style="color: blue;font-size: 18px;"></i></a>
          </td>
           <td style="border: 1px solid #F4F4F4;" align="center"><a href="<?php echo base_url() . "Add_Rs_detail/delete_rs_detail/" . $rs_detail_id; ?>" onclick="return confirm('Are you sure?')"><i class="fa fa-remove" style="color: red;font-size: 18px;"></i></a>
          </td>
        </tr>
       <?php $row_count++; } ?>
                </tbody>
