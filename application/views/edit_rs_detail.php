...
<body class="hold-transition skin-blue sidebar-mini" style="font-family: calibri;">
  ...
  <?php include 'top1.php'; ?>
   <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <?php foreach ($single_rs_detail as $p): ?>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
       <div class="col-md-3" style="margin-left: -15px;">
          <div class="small-box bg-blue-gradient">
            <div class="inner">
              <h2><?php echo $p->rs_detail_description; ?></h2>
              <h5><?php echo $p->requisition_slip_id; ?></h5>
              <p>Update Rs Detail</p>
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="#">Update Rs Detail</a></li>
    ...
    <?php echo form_open_multipart('Add_Rs_detail/update_rs_detail_id'); ?>
        <div class="row">
          ...
          <div class="box box-primary">
            <div class="box-header with-border" style="background-color: #ECF0F5;">
              ...
              <div class="box-body" style="background-color: #ECF0F5;">
               <input type="hidden" name="id" value="<?php echo $p->rs_detail_id; ?>">
            
                 
               <div class="form-group col-md-12">


                        <label for="rs_detail_description"><b>Description</b>
                        <font color="red"><p style="font-size: 8px;"><b>
                        <?php echo form_error('rs_detail_description'); ?></b></p></font>
                        </label>
                        <input onfocus="var temp_value=this.value; this.value=''; this.value=temp_value" type="text" value="<?php echo $p->rs_detail_description ; ?>" class="form-control" name="rs_detail_description" required autofocus="">


                    
                        <label for="quantity"><b>Quantity</b>
                        <font color="red"><p style="font-size: 8px;"><b>
                        <?php echo form_error('quantity'); ?></b></p></font>
                        </label>
                        <input onfocus="var temp_value=this.value; this.value=''; this.value=temp_value" type="text" value="<?php echo $p->quantity ; ?>" class="form-control" name="quantity" required autofocus="">
                        
                        
                        <label for="rate"><b>Rate</b>
                        <font color="red"><p style="font-size: 8px;"><b>
                        <?php echo form_error('rate'); ?></b></p></font>
                        </label>
                        <input onfocus="var temp_value=this.value; this.value=''; this.value=temp_value" type="text" value="<?php echo $p->rate ; ?>" class="form-control" name="rate" required autofocus="">

                        
                    
                    </div>
                        <input type="hidden" value="<?php echo ($this->session->userdata['logged_in']['user_id']); ?>" class="form-control" name="by_user" required>
                        <input type="hidden" value="<?php echo $p->requisition_slip_id; ?>" class="form-control" name="requisition_slip_id" required>
                </div>
            
 
     <button type="submit" style="width: 10%;float: left;" class="btn btn-success">Update</button>
     <a href="<?php echo base_url() . "Add_Rs_detail/insert_rs_detail" ?>">
