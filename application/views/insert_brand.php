...
<head>
  ...
  <title>Add Inventory Brand</title>
...
<body class="hold-transition skin-blue sidebar-mini" style="font-family: calibri;">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
        <div class="col-md-3" style="margin-left: -15px;">
          <div class="small-box bg-blue-gradient">
            <div class="inner">
              <h2>Add Inventory Brand</h2>
            </div>
          </div>
 </div>
      <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
        <li><a href="#">Add Inventory Brand</a></li>
    ...
    <?php echo form_open_multipart('Add_Brand/savedata'); ?>
        <div class="row">
          ...
          <div class="box box-primary">
            <div class="box-header with-border" style="background-color: #ECF0F5;">
              ...
              <div class="box-body" style="background-color: #ECF0F5;">
                 ...
                 <div class="form-group">
                  <label for="fname"><b>Brand Name</b>
            <font color="red"><p style="font-size: 8px;"><b>
             <?php echo form_error('brand_name'); ?></b></p></font>
            </label>
                     <input onfocus="var temp_value=this.value; this.value=''; this.value=temp_value" type="text" value="<?php echo set_value('brand_name'); ?>" class="form-control" name="brand_name" required autofocus="">
                </div>
            ...
            <input type="hidden" value="<?php echo ($this->session->userdata['logged_in']['user_id']); ?>" class="form-control" name="by_user" required>
             ...
             <button type="submit" style="width: 20%;float: left;" class="btn btn-success">Add New Brand</button>
             <a href="<?php echo base_url() . "Add_Brand/show_brand" ?>">
