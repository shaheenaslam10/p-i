...
<body class="hold-transition skin-blue sidebar-mini" style="font-family: calibri;">
  ...
  <div class="content-wrapper">
    ...
    <?php echo form_open_multipart('Add_Brand/update_brand_id'); ?>
        <div class="row">
          ...
          <div class="box box-primary">
            <div class="box-header with-border" style="background-color: #ECF0F5;">
              ...
              <div class="box-body" style="background-color: #ECF0F5;">
               <input type="hidden" name="id" value="<?php echo $p->brand_id; ?>">
            ...
            <font color="red"><p style="font-size: 8px;"><b>
             <?php echo form_error('brand_name'); ?></b></p></font>
                     ...
                     <input onfocus="var temp_value=this.value; this.value=''; this.value=temp_value" type="text" value="<?php echo $p->brand_name; ?>" class="form-control" name="brand_name" required autofocus="">
                </div>
