...
<style>
     #hidethis { animation: css 0s 6s forwards; }
...
<body>
    ...
    <?php echo form_open('Forgot_Password/send_email'); ?>	
    <div>
        <div class="form" style="margin-top: 3%;width: 335px;height: 150px;">
         ...
         <?php if (!empty($error_email)) { ?>
          <div style="background-color: red;border-radius: 5px;"><h3><font color="white" style="font-family: calibri;"><b><?php echo $error_email; ?></b></font></h3>
         </div>
         <?php } ?>
