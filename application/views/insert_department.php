...
<body class="hold-transition skin-blue sidebar-mini" style="font-family: calibri;">
  ...
  <div class="content-wrapper">
    ...
    <?php echo form_open_multipart('Add_Department/savedata'); ?>
        <div class="row">
          ...
          <div class="box box-primary">
            ...
            <font color="red"><p style="font-size: 8px;"><b>
             <?php echo form_error('department_name'); ?></b></p></font>
                     ...
                     <input onfocus="var temp_value=this.value; this.value=''; this.value=temp_value" type="text" value="<?php echo set_value('department_name'); ?>" class="form-control" name="department_name" required autofocus="">
                </div>
            ...
            <input type="hidden" value="<?php echo ($this->session->userdata['logged_in']['user_id']); ?>" class="form-control" name="by_user" required>
             ...
             <button type="submit" style="width: 20%;float: left;" class="btn btn-success">Add New Department</button>
