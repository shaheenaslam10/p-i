...
<body class="hold-transition skin-blue sidebar-mini" style="font-family: calibri;">
  ...
  <div class="content-wrapper">
    ...
    <?php echo form_open_multipart('Add_Request/savedata'); ?>
        <div class="row">
          ...
          <div class="box box-primary">
            <div class="box-header with-border" style="background-color: #ECF0F5;">
              ...
              <div class="box-body" style="background-color: #ECF0F5;">
                 ...
                 <div class="form-group">
                  <label for="fname"><b>Request Description</b>
                  <font color="red"><p style="font-size: 8px;"><b>
                  <?php echo form_error('request_description'); ?></b></p></font>
                  </label>
                  <input onfocus="var temp_value=this.value; this.value=''; this.value=temp_value" type="text" value="<?php echo set_value('request_description'); ?>" class="form-control" name="request_description" required autofocus="">

                </div>
   
  
                  
            <input type="hidden" value="2" class="form-control" name="request_status" required>       
            ...
            <input type="hidden" value="<?php echo ($this->session->userdata['logged_in']['department_id']); ?>" class="form-control" name="department_id" required>
            <input type="hidden" value="<?php echo ($this->session->userdata['logged_in']['user_linemanager_id']); ?>" class="form-control" name="user_linemanager_id" required>
             ...
             <button type="submit" style="width: 20%;float: left;" class="btn btn-success">Submit Request</button>
             <a href="<?php echo base_url() . "Add_Request/show_request" ?>">
